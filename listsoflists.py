...
def total_enrollment(university_para):
    i=0
    sum_of_students=0
    sum_of_fees=0
    for e in university_para:
        
        sum_of_students=sum_of_students+university_para[i][1]
        sum_of_fees=sum_of_fees+university_para[i][2]*university_para[i][1]
        i+=1
    ...
    return sum_of_students,sum_of_fees
